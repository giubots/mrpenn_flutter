...
class EntitySums extends Tool {
  ...
  const EntitySums({Key key, @required this.data}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return FutureBuilder<Map<Entity, EntityTableRow>>(
      future: data.getPrefEntitiesData(),
        ...
        if (snapshot.hasData) {
          return Table(
              children: [_buildHeader(context)]
                  ...
                  .followedBy([_buildTotal(snapshot.data, context)]).toList());
        }
  ...
  @override
  String getName(BuildContext context) =>
      AppLocalizations.of(context).entitySumsTitle;

  TableRow _buildHeader(BuildContext context) => TableRow(children: [
        Text(
          AppLocalizations.of(context).entityLabel,
          style: TextStyle(fontWeight: FontWeight.bold),
          textDirection: TextDirection.rtl,
        ),
        Text(
          AppLocalizations.of(context).untilNowLabel,
          style: TextStyle(fontWeight: FontWeight.bold),
          textDirection: TextDirection.rtl,
        ),
        Text(
  ...
  TableRow _buildTotal(
    ...
    return TableRow(children: [
      Text(
        AppLocalizations.of(context).totalLabel.toUpperCase(),
        style: TextStyle(
          fontWeight: FontWeight.bold,
        ),
        textDirection: TextDirection.rtl,
